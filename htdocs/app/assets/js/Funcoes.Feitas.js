...
function alerta(parametro, mensagem) {

    document.querySelector(".alert").style.display = "flex";
    document.querySelector(".alert small").textContent = mensagem;

    if(parametro == "success"){

        document.querySelector(".alert").classList.add("btn-success");
        setTimeout(() => {
            document.querySelector(".alert").style.display = "none";
            document.querySelector(".alert").classList.remove("btn-success");
        }, 3000);

    }else if(parametro == "danger"){

        document.querySelector(".alert").classList.add("btn-danger");
        
        setTimeout(() => {
            document.querySelector(".alert").style.display = "none";
            document.querySelector(".alert").classList.remove("btn-danger");
        }, 3000);
